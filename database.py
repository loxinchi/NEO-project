...
class NEODatabase:
    ...
    def __init__(self, neos, approaches):
        ...
        self.neos_by_desination = {neo.designation: neo for neo in self._neos}
        for approach in self._approaches:
            # look up neo through designation in the dictionary
            neo = self.neos_by_desination[approach.designation]
    ...
    def get_neo_by_designation(self, designation):
        ...
        return self.neos_by_desination.get(designation)
    ...
    def query(self, filters=None):
        ...
        if filters is None:
            filters = []
        for approach in self._approaches:
            matches = list(map((lambda x: x(approach)), filters))
            if all(matches):
                yield approach
